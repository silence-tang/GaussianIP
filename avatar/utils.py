...
from utils.graphics import fov2focal, get_projection_matrix
from utils.rotations import batch_look_at_th
...
def get_rotating_camera(img_size=1024, fov=0.5, dist=2.0, znear=0.01, zfar=100.0, device='cuda', nframes=180, angle_limit=2*torch.pi):
